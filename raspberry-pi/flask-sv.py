...
def postJsonHandler():
    ...
    if (horizontal_avg_dev1[0] > 1.5 or horizontal_avg_dev1[1] > 1.5 or horizontal_avg_dev1[2] > 1.5) or (
            horizontal_avg_dev2[0] > 1 or horizontal_avg_dev2[1] > 1 or horizontal_avg_dev2[0] > 1):
        global flag_device
        flag_device = True
        coordinates = requests.get(
            "http://api.ipstack.com/check?access_key=e8b0704f2fdaaa7d0f648d8e070916a3&fields=longitude,latitude").json()
